...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
   ...
   <body>
	    ...
	    <c:if test="${userId eq null}">
	        ...
	        <!-- <a href="https://kauth.kakao.com/oauth/authorize?client_id=f5e0701c39876968f090e686afa45c4a&redirect_uri=http://ec2-54-180-98-41.ap-northeast-2.compute.amazonaws.com:8080/appClient0917/login&response_type=code"> -->
	    ...
	    <c:if test="${userId ne null}">
	    	...
	    	<!-- <script>location.href='http://ec2-54-180-98-41.ap-northeast-2.compute.amazonaws.com:8080/appClient0917/loginCheck';</script> -->
