...
//	공구 등록. 수정. 삭제 관련----------------------------
	...
	@Autowired
	private ItemDelService delItemService;
...
//	내 공구 판매현황 관련----------------------------------
	...
	@Autowired
	private MyItemBuyerService myBuyerService;

	
//	판매현황별 기능 관련----------------------------------
	
	@Autowired	// 참여자 구매자로 선정하기
	private MyBuyerSelectService selectBuyerService;
	
	@Autowired	// 참여자 거절. 자동거절
	private MyBuyerRejectService rejectBuyerService;
	
	@Autowired
	private QRService getQRService;
	
	@Autowired
	private MyBuyerReviewService rvBuyerService;
	
	@Autowired
	private MyItemHideService hideService;
...
//	};
	...
	public int delItem(@PathVariable("iidx") int iidx) {
		...
		alarmService.deleteAlarm(0, iidx, "seller");
