...
public class Mylist {
	...
	public Mylist(int seller, int iidx, String title, int count_m, int count_w, Timestamp receive, int receive_check,
			int category, int istate, int buyer, int oidx, int ostate, int pidx, int pstate, String qr, String label) {
		this.seller = seller;
		this.iidx = iidx;
		this.title = title;
	...
	public String toString() {
		return "Mylist [seller=" + seller + ", iidx=" + iidx + ", title=" + title + ", count_m=" + count_m
				...
				+ ", pidx=" + pidx + ", pstate=" + pstate + ", qr=" + qr + ", label=" + label + "]";
	}
